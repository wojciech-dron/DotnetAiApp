...
namespace DotnetAiApp.NbpApiClient;
...
public static class Setup
{
    ...
    public static IServiceCollection AddNpbApiClient(this IServiceCollection services)
    {
        ...
        services.AddScoped<INbpApiClient, NbpApiClient.NbpApiClient>();
        services.AddHttpClient<INbpApiClient, NbpApiClient.NbpApiClient>((serviceProvider, httpClient) =>
            {
